...
describe('tz-parzer', () => {
  ...
  it('should return TZ-AVL05 data parsed', () => {
    ...
    expect(data.status.sos).to.eql(true)
    expect(data.status.input[1]).to.eql(true)
    expect(data.status.input[2]).to.eql(true)
    expect(data.status.input[3]).to.eql(false)
    expect(data.status.input[4]).to.eql(false)
    expect(data.status.input[5]).to.eql(false)
    expect(data.status.output[1]).to.eql(true)
    expect(data.status.output[2]).to.eql(true)
    expect(data.status.charge).to.eql(true)
    expect(data.datetime).to.eql(new Date('2016-02-09T19:43:26.000Z'))
    expect(data.voltage.battery).to.eql(3.98)
    expect(data.voltage.inputCharge).to.eql(11.88)
  ...
  it('should return TZ-AVL08 data parsed', () => {
    ...
    expect(data.status.input[1]).to.eql(true)
    expect(data.status.input[2]).to.eql(false)
    expect(data.status.input[3]).to.eql(true)
    expect(data.status.input[4]).to.eql(true)
    expect(data.status.input[5]).to.eql(true)
    expect(data.status.output[1]).to.eql(false)
    expect(data.status.output[2]).to.eql(false)
    expect(data.status.output[3]).to.eql(true)
  ...
  it('should return TZ-INFO data parsed', () => {
    ...
    expect(data.magneticVariation).to.eql(null)
    expect(data.gpsMode).to.eql(null)
    expect(data.sat).to.eql(4)
    expect(data.pdop).to.eql(null)
    expect(data.hdop).to.eql(2.2)
    expect(data.vdop).to.eql(null)
    expect(data.gsm).to.eql(29)
    expect(data.odometer).to.eql(0.1527)
    expect(data.datetime).to.eql(new Date('2016-02-19T15:00:17.000Z'))
    expect(data.status.raw).to.eql(null)
    expect(data.status.sos).to.eql(null)
    expect(data.status.input).to.eql(null)
    expect(data.status.output).to.eql(null)
    expect(data.status.charge).to.eql(null)
    expect(data.voltage.battery).to.eql(4.01)
    expect(data.voltage.inputCharge).to.eql(null)
    expect(data.voltage.ada).to.eql(null)
    expect(data.voltage.adb).to.eql(null)
    expect(data.lac).to.eql(null)
    expect(data.cid).to.eql(null)
    expect(data.temperature).to.eql(null)
    expect(data.serialId).to.eql(null)
    expect(data.valid).to.eql(true)
  })
  ...
  it('should return TZ-ERROR data parsed', () => {
    const raw = Buffer.from('Receive:Set Err\r\n*000000,999,9999#')
    const data = tz.parse(raw)
    expect(data.manufacturer).to.eql('tz')
    expect(data.device).to.eql('tz')
